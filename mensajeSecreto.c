...
}// sizeof(arreglo) da el tamaño que ocupa el arreglo en memoria, entoncs se calcula la cantidaded elementos que tien el arreglo dividiendo el tamaño qeocupa en memoia por el tamaño de uno de sus elementos
